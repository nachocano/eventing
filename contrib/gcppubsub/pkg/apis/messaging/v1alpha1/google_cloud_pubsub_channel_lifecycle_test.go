...
var condReady = duckv1alpha1.Condition{
	Type:   GoogleCloudPubSubChannelConditionReady,
	Status: corev1.ConditionTrue,
}

var condDispatcherReady = duckv1alpha1.Condition{
	Type:   GoogleCloudPubSubChannelConditionDispatcherReady,
	Status: corev1.ConditionTrue,
}
...
var condDispatcherServiceReady = duckv1alpha1.Condition{
	Type:   GoogleCloudPubSubChannelConditionServiceReady,
	Status: corev1.ConditionTrue,
}

var condDispatcherEndpointsReady = duckv1alpha1.Condition{
	Type:   GoogleCloudPubSubChannelConditionEndpointsReady,
	Status: corev1.ConditionTrue,
}

var condDispatcherAddressable = duckv1alpha1.Condition{
	Type:   GoogleCloudPubSubChannelConditionAddressable,
	Status: corev1.ConditionTrue,
}
...
func TestChannelGetCondition(t *testing.T) {
	tests := []struct {
		name      string
		cs        *GoogleCloudPubSubChannelStatus
...
func TestChannelInitializeConditions(t *testing.T) {
	tests := []struct {
		name string
		cs   *GoogleCloudPubSubChannelStatus
		want *GoogleCloudPubSubChannelStatus
	}{{
		name: "empty",
		cs:   &GoogleCloudPubSubChannelStatus{},
		want: &GoogleCloudPubSubChannelStatus{
			Status: duckv1alpha1.Status{
				Conditions: []duckv1alpha1.Condition{{
					...
					Type:   GoogleCloudPubSubChannelConditionChannelServiceReady,
					Status: corev1.ConditionUnknown,
				}, {
					Type:   GoogleCloudPubSubChannelConditionDispatcherReady,
					Status: corev1.ConditionUnknown,
...
func TestGoogleCloudPubSubChannelStatus_SetAddressable(t *testing.T) {
