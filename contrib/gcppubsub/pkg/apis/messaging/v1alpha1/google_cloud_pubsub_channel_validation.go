...
func (c *GoogleCloudPubSubChannel) Validate(ctx context.Context) *apis.FieldError {
	return c.Spec.Validate(ctx).ViaField("spec")
}

func (cs *GoogleCloudPubSubChannelSpec) Validate(ctx context.Context) *apis.FieldError {
