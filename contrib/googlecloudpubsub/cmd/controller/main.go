...
// This is the main method for the Google Cloud PubSub Channel controller. It reconciles the
// ClusterChannelProvisioner itself and Channels that use the 'google-cloud-pubsub' provisioner. It does not
// handle anything at the data layer.
func main() {
