...
import (
	...
	"github.com/knative/eventing/contrib/googlecloudpubsub/pkg/client/clientset/versioned/scheme"
...
type MessagingV1alpha1Interface interface {
	...
	GoogleCloudPubSubChannelsGetter
}
...
func (c *MessagingV1alpha1Client) GoogleCloudPubSubChannels(namespace string) GoogleCloudPubSubChannelInterface {
	return newGoogleCloudPubSubChannels(c, namespace)
}
