...
const (
	...
	// events.
	controllerAgentName = "rabbitmq-channel-controller"
)

// ProvideController returns a Controller that represents the rabbitmq channel Provisioner. It
// reconciles only Channels.
func ProvideController(config *provisionerController.RabbitMqProvisionerConfig) func(manager.Manager, *zap.Logger) (controller.Controller, error) {
