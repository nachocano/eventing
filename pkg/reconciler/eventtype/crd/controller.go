...
const (
	...
	ReconcilerName = "NonSourceCRDs"
	// controllerAgentName is the string used by this controller to identify
	// itself when creating events.
	controllerAgentName = "non-source-crds-controller"
)

// NewController creates a Reconciler for Non Sources' CRDs and returns the result of NewImpl.
func NewController(
	ctx context.Context,
	...
	// TODO too expensive, looking at all CRDs but sources ones. Better way of doing this?
	sourceFilterFunc := pkgreconciler.LabelFilterFunc(sources.SourceDuckLabelKey, sources.SourceDuckLabelValue, false)
	crdInformer.Informer().AddEventHandler(cache.FilteringResourceEventHandler{
		FilterFunc: pkgreconciler.Not(sourceFilterFunc),
