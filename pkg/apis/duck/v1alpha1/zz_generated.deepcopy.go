...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LocalSchemaReference) DeepCopyInto(out *LocalSchemaReference) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LocalSchemaReference.
func (in *LocalSchemaReference) DeepCopy() *LocalSchemaReference {
	if in == nil {
		return nil
	}
	out := new(LocalSchemaReference)
	in.DeepCopyInto(out)
	return out
}
