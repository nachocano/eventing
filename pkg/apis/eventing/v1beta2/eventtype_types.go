...
type EventTypeStatus struct {
	...
	// Brokers is the list of Brokers that provide this EventType.
	Brokers []string `json:"brokers,omitempty"`

	// Sources is the list of CloudEvents sources associated with this EventType.
	Sources []*apis.URL `json:"sources,omitempty"`
}
