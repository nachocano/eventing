...
import (
	...
	eventtype "knative.dev/eventing/pkg/client/injection/informers/eventing/v1/eventtype"
...
const (
	defaultControllerAgentName = "eventtype-controller"
	defaultFinalizerName       = "eventtypes.eventing.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := eventtypeInformer.Lister()
