...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1.SchemeGroupVersion.WithResource("eventtypes"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Eventing().V1().EventTypes().Informer()}, nil
	...
	case eventingv1alpha1.SchemeGroupVersion.WithResource("schemas"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Eventing().V1alpha1().Schemas().Informer()}, nil
	case eventingv1alpha1.SchemeGroupVersion.WithResource("schemagroups"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Eventing().V1alpha1().SchemaGroups().Informer()}, nil
