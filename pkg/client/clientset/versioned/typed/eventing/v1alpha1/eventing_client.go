...
func (c *EventingV1alpha1Client) Schemas(namespace string) SchemaInterface {
	return newSchemas(c, namespace)
}

func (c *EventingV1alpha1Client) SchemaGroups(namespace string) SchemaGroupInterface {
	return newSchemaGroups(c, namespace)
}
