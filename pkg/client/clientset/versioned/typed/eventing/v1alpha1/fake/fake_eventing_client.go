...
func (c *FakeEventingV1alpha1) Schemas(namespace string) v1alpha1.SchemaInterface {
	return &FakeSchemas{c, namespace}
}

func (c *FakeEventingV1alpha1) SchemaGroups(namespace string) v1alpha1.SchemaGroupInterface {
	return &FakeSchemaGroups{c, namespace}
}
