...
func (c *FakeEventTypes) Get(name string, options v1.GetOptions) (result *v1beta2.EventType, err error) {
	obj, err := c.Fake.
...
func (c *FakeEventTypes) List(opts v1.ListOptions) (result *v1beta2.EventTypeList, err error) {
	obj, err := c.Fake.
...
func (c *FakeEventTypes) Create(eventType *v1beta2.EventType) (result *v1beta2.EventType, err error) {
	obj, err := c.Fake.
...
func (c *FakeEventTypes) Update(eventType *v1beta2.EventType) (result *v1beta2.EventType, err error) {
	obj, err := c.Fake.
...
func (c *FakeEventTypes) UpdateStatus(eventType *v1beta2.EventType) (*v1beta2.EventType, error) {
	obj, err := c.Fake.
...
func (c *FakeEventTypes) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(eventtypesResource, c.ns, name), &v1beta2.EventType{})
...
func (c *FakeEventTypes) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta2.EventType, err error) {
	obj, err := c.Fake.
