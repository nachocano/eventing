...
type EventTypeInterface interface {
	Create(*v1.EventType) (*v1.EventType, error)
	Update(*v1.EventType) (*v1.EventType, error)
	Delete(name string, options *metav1.DeleteOptions) error
	DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error
	Get(name string, options metav1.GetOptions) (*v1.EventType, error)
	List(opts metav1.ListOptions) (*v1.EventTypeList, error)
	Watch(opts metav1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.EventType, err error)
	EventTypeExpansion
}
...
func newEventTypes(c *EventingV1Client, namespace string) *eventTypes {
	return &eventTypes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *eventTypes) Get(name string, options metav1.GetOptions) (result *v1.EventType, err error) {
	result = &v1.EventType{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("eventtypes").
...
func (c *eventTypes) List(opts metav1.ListOptions) (result *v1.EventTypeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.EventTypeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("eventtypes").
...
func (c *eventTypes) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *eventTypes) Create(eventType *v1.EventType) (result *v1.EventType, err error) {
	result = &v1.EventType{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("eventtypes").
...
func (c *eventTypes) Update(eventType *v1.EventType) (result *v1.EventType, err error) {
	result = &v1.EventType{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("eventtypes").
...
func (c *eventTypes) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *eventTypes) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *eventTypes) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.EventType, err error) {
	result = &v1.EventType{}
